...
const mockNews = [
  {
    ...
    content:
      '국내 스타트업이 100억 원 규모의 시리즈 A 투자를 유치하며, 글로벌 시장 진출을 가속화하고 있습니다.',
  ...
  },
  {
    ...
    content:
      '세계 각국 지도자들이 모여 기후 변화 대응을 위한 새로운 협약을 체결하였습니다.',
  ...
  },
  {
    ...
    content:
      '스마트 시티 프로젝트가 도시 생활의 혁신을 이끌며, 지속 가능한 발전을 목표로 하고 있습니다.',
  ...
  },
  {
    ...
    content:
      '자율 주행 자동차 기술이 상용화 단계에 접어들며, 교통 혁신을 예고하고 있습니다.',
  ...
  },
  {
    ...
    content:
      '최신 우주 탐사에서 새로운 행성이 발견되어, 우주 과학계에 큰 관심을 받고 있습니다.',
  ...
  },
  {
    ...
    content:
      '블록체인 기술이 금융 분야에서 혁신을 주도하며, 새로운 서비스들이 등장하고 있습니다.',
  ...
  },
  {
    ...
    content:
      '재생 에너지가 전력 생산의 주요 대안으로 부상하며, 환경 보호에 기여하고 있습니다.',
  ...
  },
  {
    ...
    content:
      '가상 현실 기술이 교육 분야에 도입되어, 학습 경험을 혁신적으로 변화시키고 있습니다.',
    imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475',
    date: '2024-11-17',
  },
]
      ...
      <ul>
        {mockNews.map((news, index) => (
          <li key={index}>
            ...
            />
            <strong className="block text-lg font-semibold mt-5">
              {news.title}
            </strong>
